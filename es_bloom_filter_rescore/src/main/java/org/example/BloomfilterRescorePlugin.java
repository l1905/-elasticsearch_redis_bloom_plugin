 ...
 */
public class BloomfilterRescorePlugin extends Plugin implements ScriptPlugin {

    private static final Logger logger = LogManager.getLogger(BloomfilterRescorePlugin.class.getName());
    ...
    private static class BloomFilterScriptEngine implements ScriptEngine {
        // 通过这两个字段判断是否使用该插件
        private final String _SOURCE_VALUE = "BloomFilterRecore";
        private final String _LANG_VALUE = "BloomFilterRecore";
        ...
        private static class UserBloomFilterFactory implements ScoreScript.Factory,
            ...
            private UserBloomFilterFactory() {
                ...
                InputStream inputStream = BloomfilterRescorePlugin.class.getClassLoader().getResourceAsStream(filename);
